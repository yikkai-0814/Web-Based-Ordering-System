 ...
 *
 * An admin has eight sections, which will not fit across a 390px screen at a readable size;
 * the row scrolls horizontally rather than shrinking the labels to nothing. Staff have
 * three, which fit comfortably, and staff are the ones actually working at this width.
 */
